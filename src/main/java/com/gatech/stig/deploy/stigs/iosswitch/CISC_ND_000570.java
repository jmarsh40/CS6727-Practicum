...
public class CISC_ND_000570 extends STIG {
    private String title = "CISC-ND-000570"; // stig ID
    private int cat = 2; // stig category
    private String description = "The Cisco switch must be configured to enforce password complexity by requiring that\n at least one uppercase character be used.";
