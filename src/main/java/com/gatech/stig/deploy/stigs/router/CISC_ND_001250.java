...
public class CISC_ND_001250 extends STIG {
    private String title = "CISC-ND-001250"; // stig ID
    private int cat = 2; // stig category
    private String description = "The Cisco router must be configured to generate log records when administrator privileges are deleted.";
