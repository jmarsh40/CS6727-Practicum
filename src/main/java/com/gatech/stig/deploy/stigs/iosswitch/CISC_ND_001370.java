...
public class CISC_ND_001370 extends STIG {
    ...
    private final String title = "CISC-ND-001370"; // stig ID
    private final int cat = 2; // stig category
    private final String description = "The Cisco switch must be configured to use at least two authentication servers for the\n purpose of authenticating users prior to granting administrative access.";
