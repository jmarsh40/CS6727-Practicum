 ...
 * @author jmarsh40
 */
public class CISC_ND_000120 extends STIG {
    private final String title = "CISC-ND-000120"; // stig ID
    private final int cat = 2; // stig category
    private final String description = "The Cisco router must be configured to automatically audit account removal actions.";
