...
import com.gatech.stig.deploy.stigs.iolrouter.*;
 ...
 * @author jmarsh40
 */
public class CISC_ND_001270 extends STIG {
    private final String title = "CISC-ND-001270"; // stig ID
    private final int cat = 2; // stig category
    private final String description = "The Cisco switch must be configured to generate log records for privileged activities.";
