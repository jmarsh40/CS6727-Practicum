 ...
 * @author jmarsh40
 */
public class CISC_ND_000110 extends STIG {
    private final String title = "CISC-ND-000110"; // stig ID
    private final int cat = 2; // stig category
    private final String description = "The Cisco switch must be configured to automatically audit account disabling actions.";
