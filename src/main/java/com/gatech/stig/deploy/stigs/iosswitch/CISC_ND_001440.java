...
public class CISC_ND_001440 extends STIG {
    ...
    private final String description = "The Cisco switch must be configured to obtain its public key certificates from an appropriate certificate policy through an approved service provider.";
